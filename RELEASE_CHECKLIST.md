...
이번 브랜치는 아이폰 개발 설치와 기능 검수를 위한 변경입니다. 이 작업 환경에서는 운영 DB 적용, Apple 계정 서명, TestFlight 업로드, App Store 제출을 실행하지 않았습니다. 사용자가 9월 16일 직접 적용한 004~006과 익명 인증 설정 완료 보고는 별도로 기록합니다. 9월 23일 새 007 SQL은 아직 적용 확인 전입니다.
