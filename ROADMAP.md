...
## Phase 3 — 서비스 기능 (진행 중)
- [x] 오늘의 정보 팝업 15종 (보험·재제작·일반, 65세 조건 필터) + 틀니 정보 수정 (2026-07-14)
...
- [x] A2 주간 리포트: 완료율·요일별 그래프·놓친 시간대 분석 + 탭바 (2026-08-28)
- [x] 알림: Capacitor local-notifications 연동 (네이티브=매일 반복, 웹=열려있을 때) (2026-07-14)
